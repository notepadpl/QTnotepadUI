...
# Project:  notepad.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile notepad.pro
#############################################################################
...
Makefile: notepad.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/notepad1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/notepad1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/notepad1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/notepad1.0.0/ && (cd `dirname .tmp/notepad1.0.0` && $(TAR) notepad1.0.0.tar notepad1.0.0 && $(COMPRESS) notepad1.0.0.tar) && $(MOVE) `dirname .tmp/notepad1.0.0`/notepad1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/notepad1.0.0
